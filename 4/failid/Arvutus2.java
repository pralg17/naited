	...
	public static void main(String[] args) throws IOException{
	    ...
	    if(Math.abs(vaikeX/suurR)<0.1){
			...
			double[] v=porkekoht(suurR, vaikeR, vaikeX);
			 ...
			 System.out.println("Põrketugevuse koefitsient: "+koef(v, suurR));
			//System.out.println("Nii kaugelt ei oska veel arvutada");
		}
		faili1.close();
	}
	//Kui suur osa maksimumjõust on põrkel tarvilik võrreldes laupkokkupõrkega	
	public static double koef(double[] pkoht, double suurR){
		double[] ristsirge={pkoht[0]/suurR, pkoht[1]/suurR};
		double[] kiirusvektor={0, 1};
		double skalaarkorrutis=ristsirge[0]*kiirusvektor[0]+ristsirge[1]*kiirusvektor[1];
